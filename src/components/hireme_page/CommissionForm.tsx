...
export const CommissionForm = () => {
  return (
    <section className="rounded-lg 2xl:rounded-2xl p-8 md:p-12 shadow-lg shadow-primary/20 border border-primary/5 bg-white w-full pb-1">
      <form className="space-y-5">
        ...
        <fieldset>
          ...
          <textarea
            name="concept"
            id="concept"
            className="w-full p-6 bg-primary/8 border-none rounded-xl focus:ring-2 focus:ring-primary/20 focus:bg-primary/10 focus:outline-none transition-all resize-none"
